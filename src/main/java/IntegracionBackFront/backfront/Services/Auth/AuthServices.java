...
public class AuthServices {
    ...
    public boolean Login(String correo, String contrasena){
        ...
        if (List.isPresent()){
            ...
            System.out.println("Usario ID encontrado: "+ usuario.getId() +
            ...
            boolean verificado = objHash.VerifyPassword(HashBD, contrasena);
            return verificado; mismo codigo de arriba pero es largo*/
        }
        return false;
    }
